    ...
    case "eiffel":
      return (
        <>
          ...
          <path d="M61 64h4l3 62H58Zm-4 70h12l7 49H50Zm-9 58h30l9 40H39Zm-12 50h54l8 26q-35-24-70 0Z" fill={ink} />
          ...
          <path d="m26 286-12 33m86-33 12 33M58 49h10" fill="none" stroke={ink} strokeWidth="2" />
        </>
      );
    case "pyramid":
      return (
      ...
      return (
        <>
          ...
          <g fill={ink} opacity=".7">
            {[3.4, 6.6, 9.8].map(x => <path key={x} d={`M${x} 28h2v5h-2zM${x} 50h2v39h-2z`} />)}
          </g>
          <path d="M2 45h12M2 48h12M2 91h12" stroke={ink} strokeWidth=".6" />
          <circle cx="8" cy="39.5" r="3.5" fill={ink} />
          <circle cx="8" cy="39.5" r="3.08" fill="none" stroke="currentColor" strokeWidth=".16" />
          <g stroke="currentColor" strokeWidth=".22">
            {Array.from({ length: 12 }, (_, i) => <path key={i} d="M8 36.7v.5" transform={`rotate(${i * 30} 8 39.5)`} />)}
            <path d="M8 37.6v1.9l1.45.85" fill="none" strokeWidth=".3" strokeLinecap="round" />
          </g>
        </>
      );
    case "liberty":
      return (
        <>
          ...
          <path d="M11 56h11v18H11zM6 84h21v1H6zM3 90h26v.8H3z" fill={ink} opacity=".45" />
          ...
          <path d="m21 23.2 5.2 1.5-2 8.3-5-1.6Z" stroke={ink} strokeWidth=".55" />
          <g stroke={ink} fill="none" strokeWidth=".65" opacity=".65" strokeLinecap="round">
    ...
    case "rocket":
      return (
        <>
          ...
          <path d="M.77 16h3.66v.35H.77zM.77 25h3.66v2.8H.77z" fill={ink} opacity=".65" />
          <path d="M.77 65.5h3.66v.5H.77z" fill={ink} opacity=".55" />
          <path d="m1.15 68-.3 2h1.1l-.15-2m.3 0L2 70h1.2L3 68m.4 0-.15 2h1.1l-.3-2" />
          <path d="m1.05 60 .5 7m2.6-7-.5 7" stroke={ink} strokeWidth=".2" fill="none" />
          <rect x="2.22" y="33" width=".76" height="8" rx=".1" fill={ink} opacity=".3" />
        </>
      );
    case "airbus":
      return (
        <>
          ...
          <g fill={ink} opacity=".8">
            {Array.from({ length: 28 }, (_, i) => <g key={i}>
              <rect x={10 + i * 1.65} y="13.7" width=".6" height=".7" rx=".23" />
              <rect x={10 + i * 1.65} y="16" width=".6" height=".7" rx=".23" />
            </g>)}
          </g>
          <g fill="none" stroke={ink} strokeWidth=".18" opacity=".5">
            {[8.3, 22, 40, 56].map(x => <rect key={x} x={x} y="15.4" width=".9" height="2.7" rx=".2" />)}
          </g>
          <path d="M9 19.3v3.5m25-1.1v1.4m7-1.2v1.2" fill="none" stroke="currentColor" strokeWidth=".5" />
          {[8.9, 33.4, 35.1, 40.6, 42.3].map(x => <circle key={x} cx={x} cy="23.4" r=".7" />)}
        </>
      );
    case "titanic":
      return (
        <>
          ...
          {[73, 109, 145, 181].map(x => <g key={x}>
            <path d={`M${x} 23l-2.2-13h10.5l2.2 13Z`} />
            <path d={`M${x - 2.2} 10h10.5l.45 2.6h-10.5Z`} fill={ink} opacity=".7" />
          </g>)}
          <path d="M47.5 0h1v30h-1zM226.5 2h1v28h-1z" />
          <path d="M48 2 18 29m30-27 24 20M227 4l-24 18m24-18 30 24M48 14h179" stroke="currentColor" strokeWidth=".35" fill="none" opacity=".8" />
          <path d="M1 35.8h262M11 45h246" stroke={ink} strokeWidth=".8" fill="none" opacity=".55" />
          <g fill={ink} opacity=".75">
            {Array.from({ length: 42 }, (_, i) => <rect key={i} x={31 + i * 4.7} y="28" width="2" height="1.4" rx=".25" />)}
            {Array.from({ length: 44 }, (_, i) => <circle key={i} cx={26 + i * 5.15} cy="40.1" r=".7" />)}
          </g>
    ...
    case "pitch":
      return (
        <>
          ...
          {[11, 52.5, 94].map(x => <circle key={x} cx={x} cy="34" r=".35" />)}
        </>
      );
  }
}
